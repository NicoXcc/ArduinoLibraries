/*
  ZerooneSupermodified_Due_Wire.h - ZeroOne Supermodified Controller API
...
#ifndef ZEROONE_SUPERMODIFIED_T3X_WIRE
#define ZEROONE_SUPERMODIFIED_T3X_WIRE

// This library supports only Teensy microcontrollers.
...
class zoSms
{
	private:
		...
		static void wireRxHandler(size_t numbytes);			
...
#error "ZerooneSupermodified_T3X_Wire can be used only on Teensy "
#endif  // #if defined(__SAM3X8E__)


#endif// ZEROONE_SUPERMODIFIED_T3X_WIRE
